        ...
        <div class="w-75">
            <v-row class="d-flex justify-center"
                ...
                <v-col lg="3" md="4" sm="6" cols="12"
                    class="d-flex justify-md-center justify-sm-end justify-center pa-1">
                    <span>I need a veterinarian in</span>
                </v-col>
                <v-col lg="3" md="4" sm="6" cols="12"
                    class="d-flex justify-md-center justify-sm-start justify-center pa-1">
